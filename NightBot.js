    ...
    */
    ...
    var basicBot = {
        ...
        chatUtilities: {
            ...
            spam: [
                'hueh', 'hu3', 'brbr', 'heu', 'brbr', 'kkkkkkkkkkkkkkkkkkkkkkkkk', 'spoder', 'mafia', 'zuera', 'zueira',
                'zueria', 'aehoo', 'aheu', 'alguem', 'algum', 'brazil', 'zoeira', 'fuckadmins', 'affff', 'vaisefoder', 'huenaarea',
                'hitler', 'ashua', 'ahsu', 'ashau', 'lulz', 'huehue', 'hue', 'huehuehue', 'merda', 'pqp', 'puta', 'mulher', 'pula', 'retarda', 'caralho', 'filha', 'ppk',
                'gringo', 'fuder', 'foder', 'hua', 'ahue', 'modafuka', 'modafoka', 'mudafuka', 'mudafoka', 'ooooooooooooooo', 'foda'
            ],
            curses: [
                'preto', 'viado', 'porra', 'caralho', 'filho da puta', 'vai se fuder'
            ]
        },
        connectAPI: function() {
            this.proxy = {
            ...
            sourceCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        API.sendChat('/me NightBot pode ser encontrado aqui: https://github.com/Koryoshe/NightBot');
                    }
                }
            },
